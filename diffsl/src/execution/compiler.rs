...
mod tests {
    ...
    generate_tests!(test_interp1d_autodiff_time);
    ...
    #[allow(dead_code)]
    fn test_interp1d_autodiff_time<
        M: CodegenModuleCompile + CodegenModuleJit,
        T: Scalar + RelativeEq,
    >() {
        run_interp1d_autodiff::<M, T>(
    ...
    tensor_test! {
        ...
        contraction_1d_to_scalar: "a_i { (0:3): 1.0 } r { a_i }" expect "r" vec![3.0],
        contraction_1d_to_scalar_diag: "a_i { (0..3): 1.0 } r { a_i }" expect "r" vec![3.0],
        contraction_1d_to_scalar_sparse: "a_i { (0): 1.0, (2): 3.0 } r { a_i }" expect "r" vec![4.0],
        contraction_1d_to_scalar_var: "a_i { 1.0, 2.0, 3.0 } r { a_i }" expect "r" vec![6.0],
        contraction_1d_to_scalar_binary: "a_i { 1.0, 2.0 } b_i { 3.0, 4.0 } r { a_i * b_i }" expect "r" vec![11.0],
        contraction_3d_to_2d: "a_ijk { (0:2, 0:3, 0:4): 2.0 } r_ij { a_ijk }" expect "r" vec![8.0, 8.0, 8.0, 8.0, 8.0, 8.0],
        contraction_3d_to_2d_sparse: "a_ijk { (0, 0, 0): 1.0, (1, 2, 3): 2.0 } r_ij { a_ijk }" expect "r" vec![1.0, 2.0],
        contraction_3d_to_2d_diag: "a_ijk { (0..3, 0..3, 0..3): 2.0 } r_ij { a_ijk }" expect "r" vec![2.0, 2.0, 2.0],
